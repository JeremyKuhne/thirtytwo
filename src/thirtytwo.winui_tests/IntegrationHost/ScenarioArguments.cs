...
internal static class ScenarioArguments
{
    internal static EnvironmentScenario Parse(string[] arguments)
    {
        ...
        return arguments[1] switch
        {
            ...
            "host-drop-target" => EnvironmentScenario.HostDropTarget,
            "host-native-text-drag" => EnvironmentScenario.HostNativeTextDrag,
            "host-text-editors" => EnvironmentScenario.HostTextEditors,
            ...
            "host-accessibility" => EnvironmentScenario.HostAccessibility,
    ...
    internal static string GetName(EnvironmentScenario scenario) => scenario switch
    {
        ...
        EnvironmentScenario.HostDropTarget => "host-drop-target",
        EnvironmentScenario.HostNativeTextDrag => "host-native-text-drag",
        EnvironmentScenario.HostTextEditors => "host-text-editors",
        ...
        EnvironmentScenario.HostAccessibility => "host-accessibility",
